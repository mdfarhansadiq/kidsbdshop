...
$FR_ptitle = "Partial Product Received Statment Invoice Based"; //Page  Title
$p = "PPRReceivedStatmentIB"; //Page Name
$inn = "#";
require_once('frd-this-header.php');
require_once('frd1_header.php');
?>
<!-- <h2 class="PT"> Partial Product Received Statment Product Based</h2> -->
...
$(document).ready(function(){
           ...
           let f_filt_limit = $('#f_filt_limit').val();
            $.ajax({
                url:FR_HURL_APII + "/PPRReceivedStatmentIB",
                method:"POST",
