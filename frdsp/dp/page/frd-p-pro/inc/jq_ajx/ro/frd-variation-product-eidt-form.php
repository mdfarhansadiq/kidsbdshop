...
<form action="" method="post" enctype="multipart/form-data">
     ...
     <div class="row mt-10 alert alert-success">
           <div class="col-xs-12">
              ...
              <input class='form-control' type="number" name="f_buy_price" id="f_buy_price" placeholder="Input Buy Price" value="<?php echo "$buy_pri";?>">
          </div>
         <div class="col-xs-4">
              <small>Market Price *</small>
              <input class='form-control' type='text' name='f_vp_market_price' id="market_price1" value="<?php echo "$pro_market_explod_0";?>" required>
         </div>
         <div class="col-xs-4">
             <small>Discount *</small>
             <input class='form-control' type='number' name='f_vp_discount' id="discount_amount1" value="<?php echo "$pro_discount_amount_explod_0";?>" required>
         </div>
         <div class="col-xs-4">
             <small>Sells Price</small>
             <input class='form-control' type='text' name='f_sellls_price' id="sellls_price1" value="<?php echo "$pro_sells_price";?>" required>
         </div>
     </div>
