...
$FR_ptitle="Rating Review Approved";//PAGE TITLE
$p="rrAproved";//PAGE NAME
$inn="";
...
<div class="row">
        ...
        <div class="col-md-6 FrRatingReviewList ">
            <?php
              $FRR = FR_QSEL("SELECT * FROM frd_rating_review WHERE fr_rr_stat = 1 ORDER BY id DESC LIMIT 0,90","ALL");
              if($FRR['FRA']==1){  
