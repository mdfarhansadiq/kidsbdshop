...
$FR_ptitle="Edit Thank You Message To Customer For Order Placed";//PAGE TITLE
$p="$FR_RP";//PAGE NAME
$inn="EditMess_OrderPlacedThankYou";
require_once('frd-this-header.php');
require_once('frd1_header.php');
?>
<h2 class="PT"> Thank You Message To Customer For Order Placed </h2>
...
$FRR = FR_QSEL("SELECT * FROM frd_pages WHERE id = 21","");
if($FRR['FRA']==1){ 
  extract($FRR['FRD']);
} else{ ECHO_4($FRR['FRM']); }
//END>>
