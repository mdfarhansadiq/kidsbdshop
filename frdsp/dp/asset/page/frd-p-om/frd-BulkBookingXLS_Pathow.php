...
$FR_ptitle="Pathao Bulk Booking XLS File";//PAGE TITLE
$p="$FR_RP";//PAGE NAME
$inn="";
require_once('frd-this-header.php');
require_once('frd1_header.php');
?>
<h2 class="PT"> Pathao Bulk Booking XLS File </h2>
...
<body>
            ...
            extract($FRR['FRD']);
              ...
              if($fr_stat == 2 || $fr_stat == 3 || $fr_stat == 4 || $fr_stat == 11 || $fr_stat == 12 || $fr_stat == 13 || $fr_stat == 14){
                        ...
                        <tr>
                            ...
                            <td>$fr_invo_due</td>
                            <td>$FRc_ItemQuantity</td>
                            <td>0.5</td>
                            <td></td>
                            <td>$FRc_Instruction</td>
                        </tr>
                        ";
                }else{
                    $FRc_TABLE_HTML .= "
    ...
    <script>
        let DownlodeFileName = '<?php echo "$FR_NOW_DATE-$fr_cname-PathaoBulkBookingXLSFile";?>';
        let DownlodeSheetName = '<?php echo "PathaoBulkBookingXLSFile";?>';
