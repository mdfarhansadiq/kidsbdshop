...
<section class="new_arrivel_secfrd hp_super_secfrd">
    <div class="container">
        ...
        <div class="row hp_sectitlfull">
            <div class="col-xs-8">
                <?php echo "<span class='hp_sectitlefrd'> $fr_hpc_text_new_products </span>"; ?>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                $FRc_PFQ = "SELECT * from frd_products WHERE statuss = 1 AND pro_typ = 1 ORDER BY frpro_priority DESC LIMIT 0,$fr_hpc_catbaspro_show";
                ...
                if ($FRR['FRA'] == 1) {
                    ...
                    echo "<div class='alert alert-danger text-center'>No More New Product Found! Right Now! s</div>";
                }
                ?>
            </div>
        </div>
