      ...
      <div class="row">
       ...
       //CATEGORY BANER       
        ...
        <div class=" text-right">
            <a class="frs_moreseebtn btn-block" href="<?php echo "$fr_cat_bpro_url/$hp_catt_slug"; ?>"> <?php echo "$hp_catt_name_bn  $fr_hpc_view_more_btn_text "; ?><span class="glyphicon glyphicon-arrow-right pip_pip_1s"></span> </a>
        </div>
