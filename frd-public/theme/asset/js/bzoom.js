(function($){
	$.fn.zoom = function(options){
		...
		var _option = {
			...
			source_image_height: 1200,	// ছবির উচ্চতা বাড়ান
			zoom_area_width: 800, 		// no effect found
			zoom_area_height: "justify",// 放大图片的展示区域的高
			zoom_area_distance: 10,     // no efffect
...
//placecode_hbsytevfxsxko6276272747484y55cxhxndu3isxsxxdd4