...
$FRc_PAGE_TITEL = "Feature Products - $fr_cmetatitle";
$FRc_META_TAG_HTML = "
...
$FRQ = $FR_CONN->query("SELECT COUNT(id) FROM frd_products WHERE frpro_featurepro = 1");
$row_totfoundoffer_c = $FRQ->fetch();
$TotalFoundOffersCount=$row_totfoundoffer_c['COUNT(id)'];
$Total_FoundOffers_notiecho="<b class='boldd'> $TotalFoundOffersCount</b> $fr_hpc_text_main_product";      
//END>>
?>
...
$(document).ready(function(){
 ...
 function load_data(limit, start)
 {
  $.ajax({
   ...
   method:"POST",
   data:{limit:limit, start:start, featureproduct:featureproduct},
   cache:false,
