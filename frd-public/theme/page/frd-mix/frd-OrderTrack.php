...
?>
<script>
    const FRc_Invoice_Id_xx = '<?php echo base64_encode($FRc_Invoice_Id_x);?>';
    const FRc_Invoice_EncId_xx = '<?php echo base64_encode($FRc_Invoice_EncId_x);?>';
</script>
<style>
   ...
   <div class="container">
        ...
        <div class="row jumbotron">
            <div class="col-md-12 text-center">
                ...
                <br>
                <?php echo " $fr_cname <br>";?>
                <b><small><?php echo  substr($FRD_HURL,8) ;?></small></b><br>
                <?php
                echo "
                    $fr_cmobile_1 <br>
                    $fr_caddress_1
            ...
            <div class="col-md-12 alert alert-success">
                <?php echo "
                    <small><b>পণ্য ডেলিভারি ঠিকানাঃ</b></small><br>
                    $fr_cust_name <br>
                        ...
                        foreach ($FRR['FRD'] as $FR_ITEM) {
                            ...
                            echo "
                                <h6>
                                    ...
                                    <img src='$FRD_HURL/frd-data/img/product/$fr_pro_pic_1' style='width: 50px; height: 50px'/> <br>
                                    </div>

                                    <span> <small>#$fr_pro_id-</small>$fr_pro_title </span> $fr_size_name_M $FRsd_ProColorName_LM $frd_sv_pro_sku_lmody | $fr_qty x " . number_format($fr_price) ."৳ = " . number_format($fr_t_price) . "৳ 
            ...
            <div class="col-md-12 alert alert-danger">
                <table class="table table-bordered" role="button">
                    <tr>
                    ...
                    <tr>
                        <td> কুপন ছাড় (-)</td>
                        <td class="text-right"><?php echo "[$fr_coup_code] ". number_format($fr_cupo_discount, 2) . " ৳"; ?></td>
                    </tr>
                    <?php } ?>
                    <tr>
                ...
                <?php if ($fr_invo_due > 0) { ?>
                    <h2 class='text-center'> <b>কন্ডিশনঃ <?php echo number_format($fr_invo_due); ?> ৳</b> </h2>
                <?php } ?>
            </div>
...
<?php require_once("compo/frd-Sec-CouponApply.php"); ?>
