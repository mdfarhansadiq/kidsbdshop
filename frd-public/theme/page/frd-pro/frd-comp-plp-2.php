              ...
              <?php
                ...
                foreach($FRQ->fetchAll() as $FR_ITEM){
                  ...
                  echo "
                    ...
                    <label for='$id' class='plp3-size-label'>  <img src='$FRD_HURL/frd-data/img/product/$pic_1' alt='#' class='' style='width:50px;height:50px;margin:auto;'> $FRc_COLOR_NAME  - <small>$frlc_tksymbol_txt $FRc_SalesPrice</small> </label><br>
                  ";
                }
              ?>
        </div>
              ...
              <?php
                ...
                foreach($FRQ->fetchAll() as $FR_ITEM){
                  ...
                  echo "
                    ...
                    <label for='$id' class='plp3-size-label'>$siz_name  - <small>$frlc_tksymbol_txt $FRc_SalesPrice</small> </label><br>
                  ";
                }
              ?>
        </div>
