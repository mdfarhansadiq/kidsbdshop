             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="popupcheckoutf" action="" method="post" autocomplete="on">
                        ...
                        <input type="hidden" class='f_product_quantity' id="f_product_quantity" value="1">
                        <input type="hidden" class="f_CHECKOUT_T_BILLL" id="f_CHECKOUT_T_BILLL" value="0.00">
                        
                    
                        <br>
                        <button class="btn btn-success btn-block frsty_theme_super_btn FrTrig_OrderPlace" type="submit"> <?php echo "$frd_placeorder_btn_txt";?> ৳ <span class="FR_CHECKOUT_T_BILL_DATA" id="FR_CHECKOUT_T_BILL_DATA">0.00</span><span class="glyphicon glyphicon-arrow-right alertt"></span></button>
