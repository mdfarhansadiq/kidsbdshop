             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="popupcheckoutf" action="" method="post" autocomplete="on">
                        ...
                        <input class="form-control" type="text" id="f_customer_name" required>

                        <small><?php echo "$frlc_mobile_number_txt";?></small>
                        <input class="form-control" type="text" id="f_customer_mobile" minlength="11" maxlength="17" required>


                        <small class=""><?php echo "$frlc_delivery_address_txt";?> <?php if ($frtc_cf_fildadress_r == 1) {echo "*";}?></small>
                        <textarea class="form-control"id="f_customer_address" cols="20" rows="2"<?php if ($frtc_cf_fildadress_r == 1) {echo "required";} ?>></textarea>


                        <?php if ($FR_Dfild_Note == "YES") { ?>
                            <small class=""><?php echo "$frlc_note_txt"; ?> </small>
                            <textarea class="form-control" name="" id="f_delivery_note" cols="20" rows="2"></textarea>
                        <?php } ?>
