...
$FR_ptitle="Order Shipping";//PAGE TITLE
$p="$FR_RP";//PAGE NAME
$inn="";
                            ...
                            echo "
                                <div class='item frtrig_search_stat' frval='$s_code' role='button' >
                                    <div class='text-center btn btn-default btn-block'>
                                        <small> <i class='fa-solid fa-truck-fast'> </i> $s_title  </small>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="FormOrderFilt" class="" action="">
                        ...
                        <input type="hidden" id="f_search_stat" value="2">
