            ...
            <tr>
                <td width="475px">
                    <div class="copy1">
                        <div>
                            ...
                            <div class="text-center"><b><small><?php echo "$FRc_SteadfastClientID_HTML";?></small></b></div>
                            <div class="text-center"><b><small><?php echo  "www.".substr($FRD_HURL,8) ;?></small></b></div>
                            <hr>
                        </div>

                        <div class=""> 
                            <small><?php echo "অর্ডার টাইম: ".date('Y-M-d h:i A', $fr_o_time)." <br>  ইনভয়েস আইডি: #$FRc_Invoice_Id_x";?></small> <br>
                            <small><?php echo "$fr_ship_track_code_HTML";?></small> <br>
                            ...
                            foreach ($FRR['FRD'] as $FR_ITEM) {
                                ...
                                <table class='items'>
                                    <tr>
                                        ...
                                        <td width='90%'>
                                          <small>$fr_pro_title [#$fr_pro_id] $fr_size_name_M $FRsd_ProColorName_LM $frd_sv_pro_sku_lmody</small>
                                        </td>
                                    </tr>
                                </table>
                                ";
                ...
                <td width="275px">
                    <div class="copy1">
                        ...
                        <div class=""> 
                            <small><?php echo "ইনভয়েস আইডি: #$FRc_Invoice_Id_x <br> অর্ডার টাইম: ".date('Y-M-d h:i A', $fr_o_time)." ";?></small><br>
                            <small><?php echo "$fr_ship_track_code_HTML";?></small> <br>
                            <small><?php echo "$fr_ship_consignment_id_HTML";?></small>
                        </div>
