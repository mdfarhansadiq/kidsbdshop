...
$FR_ptitle="Processing Complaint List";//PAGE TITLE
$p="$FR_RP";//PAGE NAME
$inn="";
require_once('frd-this-header.php');
require_once('frd1_header.php');
?>
<h2 class="PT"> Complaint Processing</h2>
...
<section>
    ...
    <div class="col-md-11">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php 
                  $FRR = FR_QSEL("SELECT * FROM frd_order_invo WHERE fr_c_stat = 1 LIMIT 0,300","ALL");
                  if($FRR['FRA']==1){ 
                         echo "<div class='table-responsive'>";
                         echo "<table class='table table-bordered'>";
                         echo "
                             <tr class='h6 alert alert-danger'>
                                 <td>SL</td>
                                 <td>Order Id</td>
                                 <td>Customer</td>
                                 <td>Complain</td>
                    ...
                    //   PR($FRR);
                    echo "<div class='text-center alert alert-danger'>No Processing Complain Found</div>";
                  }
                ?>
            </div>
        </div>
