...
?>
                ...
                <div class="row">          
                    <div class="col-md-12">
                      ...
                      <?php
                        $FRQ = "SELECT *,COUNT(id) AS FRc_T_SealsItems, SUM(fr_qty) AS FRc_T_SellsQty, SUM(fr_t_price) AS FRc_T_SellsPrice FROM frd_order_items WHERE fr_stat = 2";
                        $FRQ .= " GROUP BY fr_pro_id LIMIT 0,$f_filt_limit";
                        // echo "$FRQ";
                        $FRR = FR_QSEL("$FRQ","ALL");
                        if($FRR['FRA']==1){ 
                               ...
                               echo "
                                   <tr class='alert alert-success boldd text-center'>
                                       <td colspan='10'>Product Collection Checklist <br> <b class='text-primary'></b></td>
                                   </tr>
                               ";
                               echo "
