...
//FRD OPARATION START:-
     if($FR_VC_POST == 1){
        ...
        extract($FRQ->fetch());
                ...
                $FRQ = "SELECT * FROM frd_products WHERE statuss IN(1,2) AND v_mp_id = $FRc_MainProId AND vry_typ = 3";
                $FRR = FR_QSEL("$FRQ","ALL");
                if ($FRR['FRA'] == 1) {
                    ...
                    $FR_OP_HTML .= "
                    <div class='col-md-12'>
                      <div class='text-center boldd alert alert-danger'> No Size Variation Found (May Be This Is Size Variation Product)</div>
                    </div>
                    ";
                }
