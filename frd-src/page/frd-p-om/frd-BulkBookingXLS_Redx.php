...
$FR_ptitle="Redx Bulk Booking XLS File";//PAGE TITLE
$p="$FR_RP";//PAGE NAME
$inn="";
require_once('frd-this-header.php');
require_once('frd1_header.php');
?>
<h2 class="PT"> Redx Bulk Booking XLS File </h2>
...
<body>
    ...
    <script>
        let DownlodeFileName = '<?php echo "$FR_NOW_DATE-$fr_cname-RedxBulkBookingXLSFile";?>';
        let DownlodeSheetName = '<?php echo "RedxBulkBookingXLSFile";?>';
